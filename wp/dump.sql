...
--
-- Table structure for table `wp_advsh`
--

DROP TABLE IF EXISTS `wp_advsh`;
...
CREATE TABLE `wp_advsh` (
  ...
  `NumberPerPage` int(2) DEFAULT NULL,
  ...
  `paginationNbLimit` int(11) NOT NULL,
  `paginationDuration` int(11) NOT NULL,
  ...
  `autoCompleteType` tinyint(4) DEFAULT NULL,
  `autoCompleteNumber` tinyint(4) DEFAULT NULL,
  ...
  `autoCompleteSizeMin` tinyint(4) DEFAULT NULL,
  `autoCorrectActive` tinyint(1) NOT NULL,
  `autoCorrectType` tinyint(4) DEFAULT NULL,
...
--
-- Dumping data for table `wp_advsh`
--

LOCK TABLES `wp_advsh` WRITE;
/*!40000 ALTER TABLE `wp_advsh` DISABLE KEYS */;
INSERT INTO `wp_advsh` VALUES (1,'wordpress','wp_posts','s','post_title, post_content, post_excerpt','REGEXP','utf-8',1,0,'1',1,0,1,10,'s','','aucun','j F Y',1,1,1,1,'aucun',1,0,'D-A-C','exact',1,'post_date','DESC',0,1,'aucun',1,1,'Première page','Dernière page','&laquo; Précédent','Suivant &raquo;','trigger',5,300,'See more results','pagepost','a:1:{i:0;s:6:\"toutes\";}','Search results:','No results, please try another search!',1,'.search-field',0,0,5,1,0,'wp_autosuggest','words',1,2,1,2,1,'Try with another spelling: ',0);
/*!40000 ALTER TABLE `wp_advsh` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wp_autosuggest`
--

DROP TABLE IF EXISTS `wp_autosuggest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `wp_autosuggest`
--

LOCK TABLES `wp_autosuggest` WRITE;
/*!40000 ALTER TABLE `wp_autosuggest` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_autosuggest` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `wp_comments` VALUES (1,1,'A WordPress Commenter','wapuu@wordpress.example','https://wordpress.org/','','2025-04-24 12:33:27','2025-04-24 12:33:27','Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.',0,'1','','',0,0);
...
INSERT INTO `wp_usermeta` VALUES (1,1,'nickname','admin'),(2,1,'first_name',''),(3,1,'last_name',''),(4,1,'description',''),(5,1,'rich_editing','true'),(6,1,'syntax_highlighting','true'),(7,1,'comment_shortcuts','false'),(8,1,'admin_color','fresh'),(9,1,'use_ssl','0'),(10,1,'show_admin_bar_front','true'),(11,1,'locale',''),(12,1,'wp_capabilities','a:1:{s:13:\"administrator\";b:1;}'),(13,1,'wp_user_level','10'),(14,1,'dismissed_wp_pointers',''),(15,1,'show_welcome_panel','1'),(16,2,'wp_capabilities','a:1:{s:6:\"editor\";b:1;}'),(17,2,'wp_user_level','7');
...
INSERT INTO `wp_users` VALUES (1,'admin','$P$BRvfX7E49d7UVR/D.C.Nkz7uVuGcWC1','admin','admin@example.com','','2025-04-24 12:33:27','',0,'admin'),(2,'editor','5aee9dbd2a188839105073571bee1b1f','Editor','editor@yourdomain.com','','2020-01-01 00:00:00','',0,'');
...
-- Dump completed on 2025-04-24 12:36:34
